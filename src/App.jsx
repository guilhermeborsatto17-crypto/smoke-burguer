  ...
  return (
    <div style={{ minHeight: '100vh', background: CONFIG.bg, display: 'flex', flexDirection: 'column' }}>
      ...
      <div style={{ position: 'relative', height: 130, overflow: 'hidden' }}>
        <img src={CONFIG.heroUrl} alt="" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 10 }}>
              {produtos.map(prod => (
                <div key={prod.id} onClick={() => onEscolher(prod)} style={{
                  ...
                  <div style={{ padding: 8 }}>
                    <div style={{ color: '#fff', fontSize: 11, fontWeight: 600, lineHeight: 1.3, marginBottom: 4 }}>
                      {prod.nome}
                    </div>
                    <div style={{ color: CONFIG.cor, fontSize: 11, fontWeight: 700 }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                <div style={{
                  ...
                  background: '#2a1500', display: 'flex', alignItems: 'center', justifyContent: 'center',
                  flexShrink: 0
                }}>
                  {item.imagem_url ? (
